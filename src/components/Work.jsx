...
function Work() {
  ...
  const projects = [
...

    {
      ...
      desc: "Responsive hotel booking and room management web application.",
    },

    {
      ...
      desc: "Career guidance platform with resume analyzer and portfolio builder.",
    },
  ]
            ...
            >
              ...
              <div className="p-8 space-y-5">
                ...
                <div className="space-y-3">
                  ...
                  <h3 className="text-2xl font-semibold text-white group-hover:text-purple-400 transition duration-300">
                    {project.title}
                  </h3>
